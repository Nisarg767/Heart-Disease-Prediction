...
path_df = os.path.join(root, r'C:\Users\Nisarg Patoliya\Downloads\combined_dataset.csv')
...
model_path = os.path.join(root, r'C:\Users\Nisarg Patoliya\Downloads\rfc.sav')
joblib.dump(clf, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, r'C:\Users\Nisarg Patoliya\Downloads\scaler.pkl')
